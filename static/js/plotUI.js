...
import { trapez, parab, circ, canalcomp, meh, smih, trapCri, paraCri, circCri, resalto_rec, resalto_trap, resalto_circ, resalto_para, backm, integra_gra, breese, tra_fij, dire_pt} from './hidUtils.js'
/*
...
let f_rm_int_g = function(e){
    ...
    document.getElementById('btn-calcular').addEventListener("click", function () {
        ...
        const res = integra_gra(q, b, z1, z2, s, n, y1, y2, nt);
        let datat1 = ''
        let datat2 = ''
...
let f_rm_bakh = function(e){
    ...
    const win_body = document.getElementById("win-body");
    var data = '<div style="display: flex; flex-direction: row;">             <fieldset style="margin: 5px; width: 30%;">                     <legend> <b>Datos</b></legend>                     <div class="field-row">                         <label for="d-flow" style="width: 20%;"> Caudal: </label>                         <input id="d-flow" type="number" style="width: 60%;">                         <label for="d-flow" style="width: 20%;"> m3/s </label>                             </div>                          <div class="field-row">                                             <label for="d-b" style="width: 20%;"> Ancho de solera (b): </label>                         <input id="d-b" type="number" style="width: 60%;">                         <label for="d-b" style="width: 20%;"> m </label>                             </div>               <div class="field-row">                                             <label for="d-z1" style="width: 20%;"> Talud izquierdo: </label>                         <input id="d-z1" type="number" style="width: 60%;">                         <label for="d-z1" style="width: 20%;"> m/m </label>                             </div>               <div class="field-row">                                             <label for="d-z2" style="width: 20%;"> Talud derecho: </label>                         <input id="d-z2" type="number" style="width: 60%;">                         <label for="d-z2" style="width: 20%;"> m/m </label>                             </div>               <div class="field-row">                                             <label for="d-s" style="width: 20%;"> Pendiente (S): </label>                         <input id="d-s" type="number" style="width: 60%;">                         <label for="d-s" style="width: 20%;"> m/m </label>                             </div>               <div class="field-row">                                             <label for="d-n" style="width: 20%;"> Rugosidad (n): </label>                         <input id="d-n" type="number" style="width: 60%;">                         <label for="d-n" style="width: 20%;">  </label>                             </div>               <div class="field-row" style="flex: content;">                         <label for="d-y1" style="width: 20%;"> Tirante inicial (y1): </label>                         <input id="d-y1" type="number" style="width: 60%;">                         <label for="d-y1" style="width: 20%;"> m </label>                     </div>               <div class="field-row" style="flex: content;">                         <label for="d-y2" style="width: 20%;"> Tirante final (y2): </label>                         <input id="d-y2" type="number" style="width: 60%;">                         <label for="d-y2" style="width: 20%;"> m </label>                     </div>                 <div class="field-row" style="flex: content;">                         <label for="d-nt" style="width: 20%;"> Número de tramos (nt): </label>                         <input id="d-nt" type="number" style="width: 60%;">                         <label for="d-nt" style="width: 20%;"> m </label>                     </div>                     </fieldset>                 <fieldset style="margin: 5px; width: 70%;">                     <legend> <b>Gráfica</b></legend>                     <div id="graph-ui" style="width: 100%; height: 100%; background-color: rgb(255, 255, 255);"></div>                 </fieldset>            </div>               <div style="display: flex; flex-direction: row;">                 <fieldset style="margin: 5px; width: 90%;">                     <legend> <b>Datos parciales</b></legend>            <div> <label for="d-ynn" style="width: 10%;"> Tirante normal (m): </label>                         <input id="r-yn" type="number" style="width: 10%;" readonly="readonly"> <label for="d-yc" style="width: 10%;"> Tirante crítico: </label>                         <input id="r-yc" type="number" style="width: 10%;" readonly="readonly">  <label for="d-N" style="width: 10%;"> Valor de N: </label>                         <input id="r-N" type="number" style="width: 10%;" readonly="readonly">  <label for="d-M" style="width: 10%;"> Valor de M: </label>                         <input id="r-M" type="number" style="width: 10%;" readonly="readonly">  <label for="d-J" style="width: 10%;"> Valor de J: </label>                         <input id="r-J" type="number" style="width: 10%;" readonly="readonly"> </div>         <div class="table has-scrollbar" style="max-height:250px;  overflow:auto;">                 <table style="width: 100%;">                   <thead>                     <tr>                       <th style="width:  11.11%; ">y</th>                       <th style="width:  11.11%;">u=y/yn</th>                       <th style="width:  11.11%;">v=u(N/J)</th>                       <th style="width:  11.11%;">F(u,N)</th>                       <th style="width:  11.11%;">F(v,J)</th>                       <th style="width:  11.11%;">deltax</th>                       <th style="width:  11.11%;">x</th>                       </tr>                   </thead>                   <tbody id="tabla1">                     </tbody>                 </table>               </div>               </fieldset>                 <fieldset style="margin: 5px; width: 10%;">                     <legend> <b>Datos finales</b></legend>                     <div class="table has-scrollbar" style="max-height:250px;  overflow:auto;">                                  <table style="width: 100%;">                     <thead>                       <tr>                         <th style="width: 11.11%;">x</th>                         <th style="width: 11.11%;">y</th>                                                 </tr>                     </thead>                     <tbody id="tabla2">                                                 </tbody>                   </table>                              </div>                 </fieldset>            </div>             <fieldset style="margin: 5px;">                 <button id="btn-calcular"> Calcular</button>              <button id="btn-inicio"> Inicio</button>            </fieldset>'
    win_body.innerHTML = data;
...
let f_rm_bresse = function(e){
    ...
    const win_body = document.getElementById("win-body");
    var data = '<div style="display: flex; flex-direction: row;">             <fieldset style="margin: 5px; width: 30%;">                     <legend> <b>Datos</b></legend>                     <div class="field-row">                         <label for="d-flow" style="width: 20%;"> Caudal: </label>                         <input id="d-flow" type="number" style="width: 60%;">                         <label for="d-flow" style="width: 20%;"> m3/s </label>                             </div>                          <div class="field-row">                                             <label for="d-b" style="width: 20%;"> Ancho de solera (b): </label>                         <input id="d-b" type="number" style="width: 60%;">                         <label for="d-b" style="width: 20%;"> m </label>                             </div>                             <div class="field-row">                                             <label for="d-s" style="width: 20%;"> Pendiente (S): </label>                         <input id="d-s" type="number" style="width: 60%;">                         <label for="d-s" style="width: 20%;"> m/m </label>                             </div>               <div class="field-row">                                             <label for="d-n" style="width: 20%;"> Rugosidad (n): </label>                         <input id="d-n" type="number" style="width: 60%;">                         <label for="d-n" style="width: 20%;">  </label>                             </div>               <div class="field-row" style="flex: content;">                         <label for="d-y1" style="width: 20%;"> Tirante inicial (y1): </label>                         <input id="d-y1" type="number" style="width: 60%;">                         <label for="d-y1" style="width: 20%;"> m </label>                     </div>               <div class="field-row" style="flex: content;">                         <label for="d-y2" style="width: 20%;"> Tirante final (y2): </label>                         <input id="d-y2" type="number" style="width: 60%;">                         <label for="d-y2" style="width: 20%;"> m </label>                     </div>                 <div class="field-row" style="flex: content;">                         <label for="d-nt" style="width: 20%;"> Número de tramos (nt): </label>                         <input id="d-nt" type="number" style="width: 60%;">                         <label for="d-nt" style="width: 20%;"> m </label>                     </div>                     </fieldset>                 <fieldset style="margin: 5px; width: 70%;">                     <legend> <b>Gráfica</b></legend>                     <div id="graph-ui" style="width: 100%; height: 100%; background-color: rgb(255, 255, 255);"></div>                 </fieldset>            </div>               <div style="display: flex; flex-direction: row;">                 <fieldset style="margin: 5px; width: 90%;">                     <legend> <b>Datos parciales</b></legend>        <div class="field-row" style="flex: content;">                         <label for="r-yn" style="width: 10%;"> Tirante normal Yn: </label>                         <input id="r-yn" type="number" style="width: 30%;" readonly="readonly">                         <label for="r-yn" style="width: 10%;"> m </label>                     </div>             <div class="table has-scrollbar" style="max-height:250px; overflow:auto;">                 <table style="width: 100%;">                   <thead>                     <tr>                       <th style="width:  11.11%; ">y</th>                       <th style="width:  11.11%;">Z=y/yn</th>                       <th style="width:  11.11%;">Sx1</th>                       <th style="width:  11.11%;">F(Z)</th>                       <th style="width:  11.11%;">Sx2</th>                       <th style="width:  11.11%;">deltax</th>                       <th style="width:  11.11%;">x</th>                       </tr>                   </thead>                   <tbody id="tabla1">                     </tbody>                 </table>               </div>               </fieldset>                 <fieldset style="margin: 5px; width: 10%;">                     <legend> <b>Datos finales</b></legend>                     <div class="table has-scrollbar" style="max-height:250px;  overflow:auto;">                                  <table style="width: 100%;">                     <thead>                       <tr>                         <th style="width: 11.11%;">x</th>                         <th style="width: 11.11%;">y</th>                                                 </tr>                     </thead>                     <tbody id="tabla2">                                                 </tbody>                   </table>                              </div>                 </fieldset>            </div>             <fieldset style="margin: 5px;">                 <button id="btn-calcular"> Calcular</button>              <button id="btn-inicio"> Inicio</button>            </fieldset>'
    win_body.innerHTML = data;
...
let f_rm_dt = function(e){
    document.getElementById("title-bar-text").innerHTML = "WCanales - Curva de remanso - Directo por tramos"
    const win_body = document.getElementById("win-body");
    var data = '<div style="display: flex; flex-direction: row;">             <fieldset style="margin: 5px; width: 30%;">                     <legend> <b>Datos</b></legend>                     <div class="field-row">                         <label for="d-flow" style="width: 20%;"> Caudal: </label>                         <input id="d-flow" type="number" style="width: 60%;">                         <label for="d-flow" style="width: 20%;"> m3/s </label>                             </div>                          <div class="field-row">                                             <label for="d-b" style="width: 20%;"> Ancho de solera (b): </label>                         <input id="d-b" type="number" style="width: 60%;">                         <label for="d-b" style="width: 20%;"> m </label>                             </div>               <div class="field-row">                                             <label for="d-z1" style="width: 20%;"> Talud izquierdo: </label>                         <input id="d-z1" type="number" style="width: 60%;">                         <label for="d-z1" style="width: 20%;"> m/m </label>                             </div>               <div class="field-row">                                             <label for="d-z2" style="width: 20%;"> Talud derecho: </label>                         <input id="d-z2" type="number" style="width: 60%;">                         <label for="d-z2" style="width: 20%;"> m/m </label>                             </div>               <div class="field-row">                                             <label for="d-s" style="width: 20%;"> Pendiente (S): </label>                         <input id="d-s" type="number" style="width: 60%;">                         <label for="d-s" style="width: 20%;"> m/m </label>                             </div>               <div class="field-row">                                             <label for="d-n" style="width: 20%;"> Rugosidad (n): </label>                         <input id="d-n" type="number" style="width: 60%;">                         <label for="d-n" style="width: 20%;">  </label>                             </div>               <div class="field-row" style="flex: content;">                         <label for="d-y1" style="width: 20%;"> Tirante inicial (y1): </label>                         <input id="d-y1" type="number" style="width: 60%;">                         <label for="d-y1" style="width: 20%;"> m </label>                     </div>               <div class="field-row" style="flex: content;">                         <label for="d-y2" style="width: 20%;"> Tirante final (y2): </label>                         <input id="d-y2" type="number" style="width: 60%;">                         <label for="d-y2" style="width: 20%;"> m </label>                     </div>                 <div class="field-row" style="flex: content;">                         <label for="d-nt" style="width: 20%;"> Número de tramos (nt): </label>                         <input id="d-nt" type="number" style="width: 60%;">                         <label for="d-nt" style="width: 20%;"> m </label>                     </div>                     </fieldset>                 <fieldset style="margin: 5px; width: 70%;">                     <legend> <b>Gráfica</b></legend>                     <div id="graph-ui" style="width: 100%; height: 100%; background-color: rgb(255, 255, 255);"></div>                 </fieldset>            </div>               <div style="display: flex; flex-direction: row;">                 <fieldset style="margin: 5px; width: 90%;">                     <legend> <b>Datos parciales</b></legend>               <div class="table has-scrollbar" style="max-height: 250px; overflow:auto;">                 <table style="width: 100%;">                   <thead style="text-align:center;">                     <tr>                       <th style="width:  11.11%; text-align:center;">y</th>                       <th style="width:  11.11%;text-align:center;">A</th>                       <th style="width:  11.11%;text-align:center;">p</th>                       <th style="width:  11.11%;text-align:center;">R</th>                       <th style="width:  11.11%;text-align:center;">R^(2/3)</th>                       <th style="width:  11.11%;text-align:center;">v</th>                       <th style="width:  11.11%;text-align:center;">v^2/2g</th>                       <th style="width:  11.11%;text-align:center;">E</th>                       <th style="width:  11.11%;text-align:center;">dE</th>                       <th style="width:  11.11%;text-align:center;">Se</th>                       <th style="width:  11.11%;text-align:center;">SeP</th>                       <th style="width:  11.11%;text-align:center;">So-SeP</th>                       <th style="width:  11.11%;text-align:center;">dX</th>                       <th style="width:  11.11%;text-align:center;">X</th>       </tr>                   </thead>                   <tbody id="tabla1">                     </tbody>                 </table>               </div>               </fieldset>                 <fieldset style="margin: 5px; width: 10%;">                     <legend> <b>Datos finales</b></legend>                     <div class="table has-scrollbar" style="max-height:250px;  overflow:auto;">                                 <table style="width: 100%;">                     <thead>                    <tr>                         <th style="width: 50px;text-align:center;">x</th>                         <th style="width: 50px;text-align:center;">y</th>                                                 </tr>                     </thead>                     <tbody id="tabla2">                                                 </tbody>                   </table>                              </div>                 </fieldset>            </div>             <fieldset style="margin: 5px;">                 <button id="btn-calcular"> Calcular</button>              <button id="btn-inicio"> Inicio</button>            </fieldset>'
    win_body.innerHTML = data;
...
let f_rm_tf = function(e){
    document.getElementById("title-bar-text").innerHTML = "WCanales - Curva de remanso - Tramos fijos"
    const win_body = document.getElementById("win-body");
    var data = '<div style="display: flex; flex-direction: row;">             <fieldset style="margin: 5px; width: 40%;">                     <legend> <b>Datos</b></legend>                     <div class="field-row">                         <label for="d-flow" style="width: 20%;"> Caudal: </label>                         <input id="d-flow" type="number" style="width: 60%;">                         <label for="d-flow" style="width: 20%;"> m3/s </label>                             </div>                          <div class="field-row">                                             <label for="d-b" style="width: 20%;"> Ancho de solera (b): </label>                         <input id="d-b" type="number" style="width: 60%;">                         <label for="d-b" style="width: 20%;"> m </label>                             </div>               <div class="field-row">                                             <label for="d-z1" style="width: 20%;"> Talud izquierdo: </label>                         <input id="d-z1" type="number" style="width: 60%;">                         <label for="d-z1" style="width: 20%;"> m/m </label>                             </div>               <div class="field-row">                                             <label for="d-z2" style="width: 20%;"> Talud derecho: </label>                         <input id="d-z2" type="number" style="width: 60%;">                         <label for="d-z2" style="width: 20%;"> m/m </label>                             </div>               <div class="field-row">                                             <label for="d-s" style="width: 20%;"> Pendiente (S): </label>                         <input id="d-s" type="number" style="width: 60%;">                         <label for="d-s" style="width: 20%;"> m/m </label>                             </div>               <div class="field-row">                                             <label for="d-n" style="width: 20%;"> Rugosidad (n): </label>                         <input id="d-n" type="number" style="width: 60%;">                         <label for="d-n" style="width: 20%;">  </label>                             </div>               <div class="field-row" style="flex: content;">                         <label for="d-y1" style="width: 20%;"> Tirante inicial (y1): </label>                         <input id="d-y1" type="number" style="width: 60%;">                         <label for="d-y1" style="width: 20%;"> m </label>                     </div>                             <div class="field-row" style="flex: content;">                         <label for="d-nt" style="width: 20%;"> Número de tramos (nt): </label>                         <input id="d-nt" type="number" style="width: 60%;">                         <label for="d-nt" style="width: 20%;"> m </label>                     </div>  <div class="field-row" style="flex: content;">                         <label for="d-dx" style="width: 20%;"> TDistancia por tramo (dx): </label>                         <input id="d-dx" type="number" style="width: 60%;">                         <label for="d-dx" style="width: 20%;"> m </label>                     </div>                      </fieldset>                 <fieldset style="margin: 5px; width: 60%;">                     <legend> <b>Gráfica</b></legend>                     <div id="graph-ui" style="width: 100%; height: 100%; background-color: rgb(255, 255, 255);"></div>                 </fieldset>            </div>               <div style="display: flex; flex-direction: row;">                                 <fieldset style="margin: 5px; width: 100%;">                     <legend> <b>Datos finales</b></legend>                     <div class="has-scrollbar  table" style="max-height: 250px; ; overflow: auto">                                  <table style="width: 100%;">                     <thead>                       <tr>                         <th style="width: 50%;">x</th>                         <th style="width: 50%;">y</th>                                                 </tr>                     </thead>                     <tbody id="tabla2">                                                 </tbody>                   </table>                              </div>                 </fieldset>            </div>             <fieldset style="margin: 5px;">                 <button id="btn-calcular"> Calcular</button>              <button id="btn-inicio"> Inicio</button>            </fieldset>'
    win_body.innerHTML = data;
...
document.getElementById("rm-dpt").addEventListener("click", f_rm_dt);

document.getElementById("rm-tf").addEventListener("click", f_rm_tf);